...
using CoreResourceLoader = CoreBind::ResourceLoader;


void Module_Godot::bind_functions_extra(das::ModuleLibrary &lib) {
	// Extra bindings disabled for now pending macro updates for daScript 0.5.
	// TODO: restore ResourceLoader, Engine, Input, and Color helpers once the wrapper layer is refreshed.
